...
| 04 | [Instance step_configs + ExecutionEntry types](task-04-data-structs.md) | — | pending |
...
| 07 | [Engine: nova API](task-07-engine.md) | 04, 05, 06 | pending |
| 08 | [Runner + entry module: types](task-08-runner-entry.md) | 07 | pending |
| 09 | [Migrar tests v1 para v2](task-09-update-v1-tests.md) | 02-08 | pending |
| 10 | [Unit tests engine v2](task-10-unit-tests-engine.md) | 06, 07 | pending |
